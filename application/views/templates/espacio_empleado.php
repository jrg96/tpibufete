...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-3">
				<h3>Mis Asesorias {$estado_casos}</h3>
			</div>
			<div class="col-xs-3">
		...
		<div class="row">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="col-xs-4">
						<a href="/tpibufete/index.php/atendercaso/index/{$caso.id_caso}" class="btn btn-primary btn-block btn-lg no-rounded-corner">Consultar</a>
					</div>
				</div>
			</div>
		</div>
